...
LPAREN = "("
RPAREN = ")"
TYPES = "ENTIER"|"entier"|"REEL"|"réel"|"BOOLEEN"|"booléen"|"CARACTERE"|"caractère"|"CHAINE"|"chaine"|"TABLEAU\ DE"|"tableau\ de"|"ENTIERS"|"entiers"|"REELS"|"réels"|"BOOLEENS"|"booléens"|"CARACTERES"|"caractères"|"CHAINES"|"chaines"|"LISTE DE"|"liste de"|"T"|"V"|"FILE"|"file"|"PILE"|"pile"|"ARBRE\ DE"|"arbre\ de"|"ABR\ DE"|"abr\ de"
AFFECTATION = "<-"
